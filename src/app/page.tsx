...
const FLAT_LOADS = [
  { id: "FL-4481", from: "Jacksonville, FL", to: "Montgomery, AL", mi: 344, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Lead", certs: ["P/EVO"], pay: "FastPay", status: "open", carrier: "Sunshine State Oversize", score: 4.8 },
  { id: "FL-4490", from: "Houston, TX", to: "Oklahoma City, OK", mi: 488, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Rear", certs: ["P/EVO"], pay: "7-Day Net", status: "open", carrier: "Gulf Coast Transport LLC", score: 4.6 },
  { id: "FL-4391", from: "Columbus, OH", to: "Indianapolis, IN", mi: 174, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Lead", certs: ["P/EVO", "TWIC"], pay: "FastPay", status: "filled", carrier: "Buckeye Heavy Haul", score: 4.9 },
  { id: "FL-4402", from: "Bakersfield, CA", to: "Las Vegas, NV", mi: 280, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Lead+Rear", certs: ["P/EVO", "Witpac"], pay: "10-Day Net", status: "open", carrier: "Desert Wind Transport", score: 4.7 },
  { id: "FL-4388", from: "Memphis, TN", to: "Birmingham, AL", mi: 210, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Lead", certs: ["P/EVO"], pay: "7-Day Net", status: "open", carrier: "MidSouth Oversize", score: 4.4 },
  { id: "FL-4510", from: "Dallas, TX", to: "Shreveport, LA", mi: 193, rate: 2.00, dayRate: 500, noGo: 250, overnight: 100, pos: "Rear", certs: ["P/EVO"], pay: "FastPay", status: "open", carrier: "Lone Star Oversize LLC", score: 4.9 },
];
...
const OPEN_BIDS = [
  { id: "OB-331", from: "Houston, TX", to: "New Orleans, LA", mi: 349, rate: 2.00, pos: "Lead", certs: ["P/EVO"], carrier: "Gulf Coast Transport", score: 4.6, bids: 6, closes: "18h 22m", minPay: 1.75, maxPay: 2.00, dayRate: 500 },
  { id: "OB-288", from: "Chicago, IL", to: "Detroit, MI", mi: 281, rate: 2.00, pos: "Lead+Rear", certs: ["P/EVO", "TWIC"], carrier: "Great Lakes Heavy", score: 4.8, bids: 9, closes: "22h 05m", minPay: 1.75, maxPay: 2.00, dayRate: 500 },
  { id: "OB-299", from: "Atlanta, GA", to: "Charlotte, NC", mi: 244, rate: 2.00, pos: "Rear", certs: ["P/EVO"], carrier: "Southeast Oversize", score: 4.4, bids: 4, closes: "41h 10m", minPay: 1.75, maxPay: 2.00, dayRate: 500 },
];
...
function Ticker() {
  const items = [
    { dot: "dot-gr", text: "FL-4481 · Jacksonville FL→Montgomery AL · 344mi · $2.00/mi · FILLED · FastPay" },
    { dot: "dot-am", text: "BID BOARD LIVE · BID-771 · Dallas TX→Memphis TN · 3:12 remaining · 3 bids · low $2.00/mi" },
    ...
    { dot: "dot-am", text: "BID-559 FILLED · Nashville→St. Louis · Rick B. wins · $2.00/mi" },
    { dot: "dot-gr", text: "Lone Star Oversize LLC · Pay Score 4.9 · load filled in 3 min" },
    { dot: "dot-or", text: "OPEN BID · IL→MI · 281mi · 9 bids · low $2.00/mi · 22h remaining" },
  ];
  return (
  ...
  return (
    <div className="nav">
      <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }} onClick={() => setPage("home")}>
        <img src="/logo.png" alt="Oversize Escort Hub" style={{ height: 36, width: "auto", display: "block" }} />
      </div>
      ...
      <div className="footer-grid">
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            <img src="/logo.png" alt="Oversize Escort Hub" style={{ height: 28, width: "auto", display: "block" }} />
          </div>
  ...
  return (
    <>
      <div className="bid-strip">
        <div className="bid-live"><img src="/bid.png" alt="Bid" style={{ height: 18, width: "auto", marginRight: 6, verticalAlign: "middle" }} />5-Min Bid Board</div>
      ...
      <div className="hero">
        <div className="hero-carrier">
          <div className="hero-inner">
            ...
            <p className="hero-sub">Standard $2.00/mi run. Winning bids on our board come in at $2.00. On 3–4 loads/week that's <strong style={{ color: "var(--t1)" }}>$1,500–$2,000 back in your pocket monthly.</strong></p>
      ...
      <div className="platform-div">
        ...
        <span className="mo" style={{ marginLeft: "auto", fontSize: 9, letterSpacing: ".1em", textTransform: "uppercase" as const, color: "var(--t2)" }}>$670M US Market · 50,000+ P/EVO Operators</span>
      </div>
      ...
      <div className="section" style={{ paddingBottom: 0 }}>
        ...
        <div className="data-table">
          <table>
            <thead>
              <tr>
                <th>Load ID</th><th>Route</th><th>Miles</th><th>Rate</th><th>Day Rate</th><th>No-Go Fee</th><th>Position</th><th>Certs</th><th>Pay Terms</th><th>Pay Score</th><th>Contact</th><th>Status</th><th></th>
              </tr>
            </thead>
            <tbody>
              {FLAT_LOADS.slice(0, 5).map((l) => (
                <tr key={l.id} style={{ opacity: l.status === "filled" ? 0.42 : 1 }}>
                  ...
                  <td className="mo" style={{ color: "var(--bl)" }}>${l.dayRate}/day</td>
                  <td className="mo" style={{ color: "var(--t2)" }}>${l.noGo} half</td>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 36 }}>
            <div>
              ...
              <div style={{ background: "var(--bg)", border: "1px solid var(--l1)", borderRadius: 3, padding: 14, marginBottom: 16 }}>
                ...
                {[["Deadhead cost (80mi × $0.67/mi)", "−$53.60", "var(--rd)"], ["Load pay ($2.00/mi × 340mi)", "+$884.00", "var(--gr)"], ["Net after deadhead", "$626.40", "var(--gr)"]].map(([l, v, c], i) => (
    ...
    <div className="card">
      ...
      <div style={{ display: "flex", gap: 4, flexWrap: "wrap" as const, marginBottom: 10 }}>
        {e.badges.slice(0, 3).map((b) => (
          <span key={b} className={`chip ${b === "Rate Reliable" ? "ch-am" : "ch-gr"}`}>
            {b === "P/EVO Verified" ? <img src="/verified.png" alt="verified" style={{ height: 10, width: "auto", marginRight: 3, verticalAlign: "middle" }} /> : "✓ "}
            {b}
          </span>
        ))}
      </div>
  ...
  return (
    <div className="section">
      <div style={{ background: "var(--p2)", border: "1px solid var(--l1)", borderLeft: "3px solid var(--am)", borderRadius: 4, padding: "16px 20px", marginBottom: 20 }}>
        <div className="bb" style={{ fontSize: 22, color: "var(--am)", marginBottom: 6, display: "flex", alignItems: "center", gap: 10 }}><img src="/bid.png" alt="Bid Board" style={{ height: 28, width: "auto" }} />5-MINUTE BID BOARD</div>
        ...
        {OPEN_BIDS.map((l) => (
          <div key={l.id} className="card">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 }}>
              {[["Miles", `${l.mi} mi`], ["Ceiling", `$${l.rate.toFixed(2)}/mi`], ["Position", l.pos], ["Bids In", `${l.bids} bids`], ["Bid Range", `$${l.minPay}–$${l.maxPay}/mi · Day: $${l.dayRate}`], ["Closes", l.closes]].map(([lbl, val]) => (
                <div key={lbl}>
              ...
              {[["Lead", ESCORTS[0], "var(--gr)"], ["Rear", ESCORTS[1], "var(--gr)"], ["High Pole", null, "var(--am)"]].map(([pos, esc, c]) => (
                <div key={pos as string} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid var(--l1)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                    <span className="chip ch-dim">{typeof pos === 'string' ? pos : null}</span>
                    {esc ? (
                      <div>
    ...
    <div className="postload-wrap">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        ...
        <div className="form-field">
          ...
          <select style={{ width: "100%" }}>
            <option>FastPay (same-day)</option><option>7-Day Net</option><option>10-Day Net</option><option>15-Day Net</option>
          </select>
        </div>
        <div className="form-field">
    ...
    <div className="section">
      ...
      {[
        ...
        <div key={v.tier} className="verify-tier" style={{ borderLeftColor: v.c }}>
          ...
          <button className="btn btn-ghost btn-sm" style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: 6 }}><img src="/pending.png" alt="pending" style={{ height: 12, width: "auto" }} />Start Verification</button>
        </div>
      ))}
